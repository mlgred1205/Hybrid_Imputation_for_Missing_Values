...
tag = "MDA_Sim_Amp_Mid"
tag2 = "MDA_Sim_Amp_KNN_Mid"
tag3 = "MDA_Sim_Amp_MLE_Mid"
tag4 = "MDA_Sim_Amp_SVD_Mid"
tag5 = "MDA_Sim_Amp_MinDet_Mid"
tag6 = "MDA_Sim_Amp_MinProb_Mid"
tag7 = "MDA_Sim_Amp_QRILC_Mid"
tag8 = "MDA_Sim_Amp_Hybrid_Mid"
...
ampdata1 <- ampute(df3, patterns = my_pattern, 
                   prop = 0.5, mech = "MAR")$amp
ampdata2 <- ampute(df3, patterns = my_pattern2, 
                   prop = 0.5, mech = "MNAR")$amp
...
write.csv(MV_Final, "AmputedData_MVType_MidMV_50.csv")
...
df4 = data.frame(ProteinID = row.names(df3), data2, 
                 row.names = NULL)
write.csv(df4, "MDA_Sim_Amp_Data_Mid.csv", row.names = F)

#PLOT MISSING DATA PATTERN AND ADD UP NUMBER OF MISSING VALUES
pdf("MD_Pattern_Sim_Amp_Mid.pdf")
...
annotate_figure(figure, top = text_grob("MAR KNN Imputation Sim Amp MDA: MidMV", face = "bold", size = 18), 
