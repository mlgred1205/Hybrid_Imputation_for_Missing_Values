...
tag = "MDA_Sim_Amp_HighMNAR"
tag2 = "MDA_Sim_Amp_KNN_HighMNAR"
tag3 = "MDA_Sim_Amp_MLE_HighMNAR"
tag4 = "MDA_Sim_Amp_SVD_HighMNAR"
tag5 = "MDA_Sim_Amp_MinDet_HighMNAR"
tag6 = "MDA_Sim_Amp_MinProb_HighMNAR"
tag7 = "MDA_Sim_Amp_QRILC_HighMNAR"
tag8 = "MDA_Sim_Amp_Hybrid_HighMNAR"
...
ampdata1 <- ampute(df3, patterns = my_pattern, 
                   prop = 0.2, mech = "MAR")$amp
ampdata2 <- ampute(df3, patterns = my_pattern2, 
                   prop = 0.8, mech = "MNAR")$amp
...
write.csv(MV_Final, "AmputedData_MVType_HighMNAR.csv")
...
df4 = data.frame(ProteinID = row.names(df3), data2, 
                 row.names = NULL)
write.csv(df4, "MDA_Sim_Amp_Data_HighMNAR.csv", row.names = F)

#PLOT MISSING DATA PATTERN AND ADD UP NUMBER OF MISSING VALUES
pdf("MD_Pattern_Sim_Amp_HighMNAR.pdf")
...
annotate_figure(figure, top = text_grob("MAR KNN Imputation Sim Amp MDA:HighMNAR", face = "bold", size = 18), 
